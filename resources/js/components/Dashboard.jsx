// filepath: c:\xampp\htdocs\Password-Saving-Application\resources\js\components\Dashboard.jsx
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">Welcome back! Here's your password security overview.</p>
                                </div>
...
const RecentActivity = () => {
    const activities = [
        ...
        { text: "New password added for Facebook", time: "1 day ago", color: "blue" },
